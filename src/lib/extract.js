...
console.assert(
  extractFR1("FR1:041.09 m3/Hr")?.raw === "041.09",
  "Should extract 041.09"
);
console.assert(
  extractFR1("FR1:041.09 m3/Hr")?.normalized === "41.09",
  "Should normalize to 41.09"
);
console.assert(
  extractFR1("FR1: 7.5 m3/Hr")?.raw === "7.5",
  "Should handle spaces"
);
console.assert(
  extractFR1("invalid text") === null,
  "Should return null for invalid text"
);
